...
shiny_react_deps = HTMLDependency(
    "shiny_react",
    "1.0.0",
    source={
        "package": "shiny_react",
...
# Output component
class render_shiny_react(Renderer[str]):
    """
    ...
    def auto_output_ui(self) -> Tag:
        return output_shiny_react(self.output_id)

    # # There are no parameters being supplied to the `output_shiny_react` rendering function.
